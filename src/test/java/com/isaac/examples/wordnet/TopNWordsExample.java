...
public class TopNWordsExample {
	...
	public static void main(String[] args) throws IOException {
		...
		long maxLength = 1000;
		List<String> topNWords = Files.readAllLines(Paths.get(WordNet.GLOBALPATH.concat("data/upd_corewn_with_sense.txt")))
				.stream()
		...
		/* write to file */
		BufferedWriter writer = new BufferedWriter(new FileWriter(WordNet.GLOBALPATH.concat(filePath)));
