...
public class WordNetToNeo4JCypher {
    public static void main (String[] args) throws IOException {
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(WordNetUtils.GLOBALPATH.concat(outfilename)));
    ...
    private static List<String> createCypher(List<LinkedList<SynsetElement>> list, POS tag) {
        ...
        for (Map.Entry<String, WordElement> entry : map.entrySet()) {
            ...
            for (Map.Entry<ISynset, IWord> en : eleMap.entrySet()) {
                int senseNumber = WordNetUtils.getSenseNumber4IWord(en.getValue());
                int tagCount = WordNetUtils.getTagCount4IWord(en.getValue());
