...
public class MannerResultVerbHierarchiesToCypher {
	...
	public static void main(String[] args) throws IOException {
        ...
        List<String> resultSynsetsString = Files.readAllLines(Paths.get(WordNetUtils.GLOBALPATH.concat("data/104-result-verbs.txt")));
		...
		// write to file
        BufferedWriter writer = new BufferedWriter(new FileWriter(WordNetUtils.GLOBALPATH.concat("data/manner_result_verbs_cypher.txt")));
